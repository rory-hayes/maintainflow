...
| GitHub CI / CodeQL | **Both passed on pushed application commit** | CI run `34579594523` completed successfully at 08:32:49 UTC; CodeQL run `34579594145` at 08:32:56 UTC. Both verified `6b531d8ca3e085afc61feae5091af24671444b9b`. New CI uses isolated PostgreSQL and Node 24; prior MaintainCode Ads results are separate. |
...
The application replacement was pushed as [`6b531d8ca3e085afc61feae5091af24671444b9b`](https://github.com/rory-hayes/maintainflow/commit/6b531d8ca3e085afc61feae5091af24671444b9b), verified through remote Git refs and the refreshed GitHub page. The `evidence/migration-2026-09-11/repository-after.json` receipt records that application commit and post-push domain state. This verification documentation is committed afterward without changing the tested application. The code is developed under the Folio name; MaintainFlow is the repository/domain and test billing identity for the replacement. Public branding and final launch copy can be aligned during the production release.

Post-push Vercel deployment `dpl_HJTHu6mU4xidfR16pQp8n3Z5AVpi` was `CANCELED` by the expected hold. The domain still reports `maintaincode-ads`, revision `2ad3baf4aa27a3ac3d3c6a07c80b23b55e706147`. Repository replacement is complete; domain cutover remains a hosted acceptance gate.
