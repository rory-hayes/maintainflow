...
const events = [
  ...
  "ads.integrity_review.failed",
  "ads.integrity_review.rejected",
  "ads.integrity_review.unavailable",
  "ads.integrity_events.failed",
  "ads.integrity_events.loaded",
  "ads.integrity_events.unavailable",
  ...
  "approval_notifications.run.failed",
  "approval_notifications.run.unconfigured",
  ...
  "workspace.change_approval_requests_load_failed",
  "workspace.change_integrity_load_failed",
...
const scopes = [
  ...
  "monitoring.runner",
  "api.ads.apply",
  "api.ads.integrity_review",
  "api.ads.integrity_events",
  "api.ads.rollback",
  "api.ads.reconcile",
...
const errorKinds = new Map([
  ...
  ["OperatorAdmissionForbiddenError", "authorization_error"],
